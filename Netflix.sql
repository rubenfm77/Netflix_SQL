...
-- 13. Find how many movies the actor 'Salman Khan' appeared in the las 10 years.
...
-- 15. Categorize the content based on the presence of keywords 'kill' and 'violence' in 
-- the description field, label content containing keywords as 'bad' and all other content 
